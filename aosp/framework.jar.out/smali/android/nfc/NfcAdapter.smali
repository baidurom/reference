...
.field public static final ACTION_CONNECTIVITY_EVENT_DETECTED:Ljava/lang/String; = "android.nfc.action.CONNECTIVITY_EVENT_DETECTED"
...
.method public disableForegroundDispatch(Landroid/app/Activity;)V
    ...
    .line 775
    .local v0, thrd:Landroid/app/ActivityThread;
    if-eqz v0, :cond_0
    ...
    invoke-virtual {p0, p1, v1}, Landroid/nfc/NfcAdapter;->disableForegroundDispatchInternal(Landroid/app/Activity;Z)V
...
.method public enableForegroundDispatch(Landroid/app/Activity;Landroid/app/PendingIntent;[Landroid/content/IntentFilter;[[Ljava/lang/String;)V
    ...
    const-string v5, "Foreground dispatch can only be enabled when your activity is resumed"
    ...
    .line 750
    .local v3, thrd:Landroid/app/ActivityThread;
    if-eqz v3, :cond_4
    ...
    invoke-interface {v4, p2, p3, v1}, Landroid/nfc/INfcAdapter;->setForegroundDispatch(Landroid/app/PendingIntent;[Landroid/content/IntentFilter;Landroid/nfc/TechListParcel;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0

    .line 757
    .end local v3           #thrd:Landroid/app/ActivityThread;
    :goto_0
    return-void
