...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    .prologue
    .line 125
    const v0, #attr@timePickerStyle#t
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    const v9, #id@numberpicker_input#t
    ...
    const v5, #string@time_picker_separator#t

    invoke-virtual {v4, v5}, Landroid/widget/TextView;->setText(I)V

    .line 170
    :cond_0
    const v4, #id@minute#t
...
.method private setContentDescriptions()V
    ...
    .prologue
    const v4, #id@decrement#t

    const v3, #id@increment#t

    .line 520
    iget-object v1, p0, Landroid/view/View;->mContext:Landroid/content/Context;

    const v2, #string@time_picker_increment_minute_button#t
    ...
    const v2, #string@time_picker_decrement_minute_button#t
    ...
    const v2, #string@time_picker_increment_hour_button#t
    ...
    const v2, #string@time_picker_decrement_hour_button#t
    ...
    const v2, #string@time_picker_increment_set_pm_button#t
    ...
    const v2, #string@time_picker_decrement_set_am_button#t
