...
.method private enableRadio()V
    ...
    invoke-direct {v3, p0, v1, v2, v0}, Lcom/android/server/power/QuickbootManager$1;-><init>(Lcom/android/server/power/QuickbootManager;J[Z)V
...
.method private stopEverything(Landroid/content/Context;)V
    ...
    invoke-interface {v3, v15, v0}, Landroid/app/IActivityManager;->forceStopPackage(Ljava/lang/String;I)V
    :try_end_0
    ...
    invoke-interface {v3, v0, v1}, Landroid/app/IActivityManager;->forceStopPackage(Ljava/lang/String;I)V
...
.method public restoreSystemStates(Landroid/content/Context;)V
    ...
    invoke-static {v2, v6, v9}, Landroid/provider/Settings$Global;->getInt(Landroid/content/ContentResolver;Ljava/lang/String;I)I
    ...
    invoke-static {v6}, Landroid/bluetooth/IBluetoothManager$Stub;->asInterface(Landroid/os/IBinder;)Landroid/bluetooth/IBluetoothManager;

    move-result-object v3

    .line 151
    .local v3, iBt:Landroid/bluetooth/IBluetoothManager;
    if-eqz v3, :cond_5
    ...
    .line 159
    .end local v3           #iBt:Landroid/bluetooth/IBluetoothManager;
    :cond_5
    :goto_1
    ...
    .restart local v3       #iBt:Landroid/bluetooth/IBluetoothManager;
    :catch_1
    move-exception v6
...
.method shutdown(Landroid/content/Context;)Z
    .locals 1
    .parameter "context"
...
.method shutdown(Landroid/content/Context;Landroid/app/AlarmManager$PoweroffAlarm;)Z
    .locals 7
    .parameter "context"
