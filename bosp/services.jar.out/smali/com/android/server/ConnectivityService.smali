...
.field private static final DefaultyCountryCode:Ljava/lang/String; = "EU"
...
.field private static final WiFi_NVRAM_SET:Ljava/lang/String; = "nvram_set"
...
.method public constructor <init>(Landroid/content/Context;Landroid/os/INetworkManagementService;Landroid/net/INetworkStatsService;Landroid/net/INetworkPolicyManager;)V
    ...
    iget-object v10, v0, Lcom/android/server/ConnectivityService;->mNetConfigs:[Landroid/net/NetworkConfig;

    .local v10, arr$:[Landroid/net/NetworkConfig;
    array-length v0, v10
    ...
    .line 539
    .end local v10           #arr$:[Landroid/net/NetworkConfig;
    :cond_11
    const/16 v2, 0x26
    ...
    iget-object v10, v0, Lcom/android/server/ConnectivityService;->mPriorityList:[I
    ...
    .line 561
    .restart local v29       #netType:I
    :pswitch_1
    new-instance v38, Landroid/net/wifi/WifiStateTracker;
    ...
    invoke-direct {v0, v1, v2}, Landroid/net/wifi/WifiStateTracker;-><init>(ILjava/lang/String;)V

    .line 563
    .local v38, wst:Landroid/net/wifi/WifiStateTracker;
    invoke-direct/range {p0 .. p0}, Lcom/android/server/ConnectivityService;->getPersistedNvRamSet()Z
    ...
    const v3, #string@I_SDMID_WIFI_CHANNEL_CONFIG#t
    ...
    const-string v3, "wifi channel set by DefaultyCountryCode"
    ...
    invoke-direct {v0, v2}, Lcom/android/server/ConnectivityService;->persistNvRamSet(Z)V
    ...
    .line 607
    .end local v38           #wst:Landroid/net/wifi/WifiStateTracker;
    :cond_17
    :goto_10
    move-object/from16 v0, p0
    ...
    .restart local v38       #wst:Landroid/net/wifi/WifiStateTracker;
    :cond_18
    const-string v2, "ConnectivityService"

    const-string v3, "wifi channel set by Country Code"
    ...
    invoke-virtual {v0, v9}, Landroid/net/wifi/WifiStateTracker;->WriteNvram(Ljava/lang/String;)Z
...
.method static synthetic access$4000(Lcom/android/server/ConnectivityService;Ljava/lang/Long;)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$4200(Lcom/android/server/ConnectivityService;ZZ)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
    .parameter "x2"
...
.method private getPersistedNvRamSet()Z
    .locals 3
...
.method private handleMobileDataConnectionChange(Ljava/lang/Long;)V
    ...
    .restart local v10       #preSimSlot:I
    :cond_6
    :try_start_3
...
.method private persistNvRamSet(Z)V
    .locals 3
    .parameter "enabled"
    ...
    const-string v2, "Set NvRAM successful!"
