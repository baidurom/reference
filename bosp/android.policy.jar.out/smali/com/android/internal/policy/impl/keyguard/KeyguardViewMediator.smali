...
.method public constructor <init>(Landroid/content/Context;Lcom/android/internal/widget/LockPatternUtils;)V
    ...
    const v6, #integer@config_lockSoundVolumeDb#t
...
.method private adjustStatusBarLocked()V
    ...
    const v4, #string@status_bar_device_locked#t
    ...
    const v5, #drawable@stat_sys_secure#t
    ...
    invoke-virtual {v3}, Lcom/android/internal/policy/impl/keyguard/KeyguardUpdateMonitor;->isStatusBarExpandEnbale()Z
...
.method private doKeyguardLocked(Landroid/os/Bundle;)V
    ...
    .prologue
    .line 976
    const-string v15, "persist.sys.monkey"
    ...
    .line 981
    :cond_0
    sget-boolean v15, Lcom/android/internal/policy/impl/keyguard/KeyguardViewMediator;->mExternallyEnabled:Z
    ...
    const-string v16, "doKeyguard: not showing because externally disabled"

    invoke-static/range {v15 .. v16}, Lcom/android/internal/policy/impl/keyguard/KeyguardUtils;->xlogD(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v15, v0, Lcom/android/internal/policy/impl/keyguard/KeyguardViewMediator;->mKeyguardViewManager:Lcom/android/internal/policy/impl/keyguard/KeyguardViewManager;

    invoke-virtual {v15}, Lcom/android/internal/policy/impl/keyguard/KeyguardViewManager;->isShowing()Z
    ...
    const-string v16, "doKeyguard: not showing because it is already showing"
    ...
    const-string v16, "doKeyguard: get keyguard.no_require_sim property before"

    invoke-static/range {v15 .. v16}, Lcom/android/internal/policy/impl/keyguard/KeyguardUtils;->xlogD(Ljava/lang/String;Ljava/lang/String;)V

    .line 1004
    const-string v15, "keyguard.no_require_sim"
    ...
    const-string v16, "doKeyguard: get keyguard.no_require_sim property after"
    ...
    iget-object v15, v0, Lcom/android/internal/policy/impl/keyguard/KeyguardViewMediator;->mUpdateMonitor:Lcom/android/internal/policy/impl/keyguard/KeyguardUpdateMonitor;

    invoke-virtual {v15}, Lcom/android/internal/policy/impl/keyguard/KeyguardUpdateMonitor;->isDeviceProvisioned()Z
    ...
    invoke-virtual {v15}, Lcom/android/internal/policy/impl/keyguard/KeyguardUpdateMonitor;->getSimState()Lcom/android/internal/telephony/IccCardConstants$State;

    move-result-object v12

    .line 1009
    .local v12, state:Lcom/android/internal/telephony/IccCardConstants$State;
    const/4 v6, 0x0
    ...
    invoke-virtual/range {v15 .. v16}, Lcom/android/internal/policy/impl/keyguard/KeyguardUpdateMonitor;->getSimState(I)Lcom/android/internal/telephony/IccCardConstants$State;

    move-result-object v13

    .line 1012
    .local v13, stateGemini:Lcom/android/internal/telephony/IccCardConstants$State;
    ...
    invoke-virtual/range {v15 .. v17}, Lcom/android/internal/policy/impl/keyguard/KeyguardUpdateMonitor;->getPINDismissFlag(IZ)Z
    ...
    :cond_5
    sget-object v15, Lcom/android/internal/telephony/IccCardConstants$State;->PERM_DISABLED:Lcom/android/internal/telephony/IccCardConstants$State;
    ...
    .line 1016
    .local v11, simLockedOrMissing:Z
    :goto_2
    sget-object v15, Lcom/android/internal/telephony/IccCardConstants$State;->PIN_REQUIRED:Lcom/android/internal/telephony/IccCardConstants$State;
    ...
    .line 1020
    .local v10, simGeminilockedOrMissing:Z
    :goto_3
    if-nez v11, :cond_a
    ...
    .line 1028
    .end local v10           #simGeminilockedOrMissing:Z
    .end local v11           #simLockedOrMissing:Z
    .end local v13           #stateGemini:Lcom/android/internal/telephony/IccCardConstants$State;
    :goto_4
    const-string v15, "KeyguardViewMediator"

    const-string v16, "doKeyguard: get sim state after"
    ...
    iget-object v15, v0, Lcom/android/internal/policy/impl/keyguard/KeyguardViewMediator;->mLockPatternUtils:Lcom/android/internal/widget/LockPatternUtils;

    invoke-virtual {v15}, Lcom/android/internal/widget/LockPatternUtils;->isLockScreenDisabled()Z
    ...
    const-string v16, "doKeyguard: keyguardDisable query end"
    ...
    iget-object v15, v0, Lcom/android/internal/policy/impl/keyguard/KeyguardViewMediator;->mContext:Landroid/content/Context;
    ...
    invoke-virtual {v15}, Lcom/android/internal/policy/impl/keyguard/KeyguardUpdateMonitor;->dmIsLocked()Z
    ...
    const-string v17, "lockedOrMissing is "
    ...
    const-string v17, ", keyguardisable="
    ...
    const-string v16, "doKeyguard: not showing because device isn\'t provisioned and the sim is not locked or missing"
    ...
    .end local v12           #state:Lcom/android/internal/telephony/IccCardConstants$State;
    :cond_b
    const/4 v9, 0x0
    ...
    .restart local v12       #state:Lcom/android/internal/telephony/IccCardConstants$State;
    .restart local v13       #stateGemini:Lcom/android/internal/telephony/IccCardConstants$State;
    :cond_c
    const/4 v11, 0x0
    ...
    .line 1016
    .restart local v11       #simLockedOrMissing:Z
    :cond_d
    const/4 v10, 0x0
    ...
    .line 1020
    .restart local v10       #simGeminilockedOrMissing:Z
    :cond_e
    const/4 v6, 0x0
    ...
    const-string v15, "lockscreen.disabled"
    ...
    iget-object v15, v0, Lcom/android/internal/policy/impl/keyguard/KeyguardViewMediator;->mUserManager:Landroid/os/UserManager;
    ...
    const-string v16, "doKeyguard: not showing because lockscreen is off"
    ...
    const-string v16, "doKeyguard: showing the lock screen"
...
.method private startAlarm()V
    ...
    const-string v1, "com.baidu.baiduclock.ALARM_ALERT"
