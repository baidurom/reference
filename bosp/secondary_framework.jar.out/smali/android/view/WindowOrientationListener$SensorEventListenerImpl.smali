...
.method public constructor <init>(Landroid/view/WindowOrientationListener;)V
    ...
    .line 242
    iput v3, p0, Landroid/view/WindowOrientationListener$SensorEventListenerImpl;->mHistoryIndex:I

    .line 243
    iput v3, p0, Landroid/view/WindowOrientationListener$SensorEventListenerImpl;->mHistoryLength:I
...
.method private updateProposal(IJFII)V
    ...
    .prologue
    .line 570
    iget v7, p0, Landroid/view/WindowOrientationListener$SensorEventListenerImpl;->mProposalRotation:I
    ...
    iput v7, p0, Landroid/view/WindowOrientationListener$SensorEventListenerImpl;->mHistoryIndex:I

    .line 574
    const/4 v7, 0x0

    iput v7, p0, Landroid/view/WindowOrientationListener$SensorEventListenerImpl;->mHistoryLength:I

    .line 576
    :cond_0
    iget-object v7, p0, Landroid/view/WindowOrientationListener$SensorEventListenerImpl;->mOrientationListener:Landroid/view/WindowOrientationListener;

    iget-boolean v5, v7, Landroid/view/WindowOrientationListener;->mLogEnabled:Z

    .line 577
    .local v5, log:Z
    iget v4, p0, Landroid/view/WindowOrientationListener$SensorEventListenerImpl;->mHistoryIndex:I

    .line 578
    .local v4, index:I
    iget-object v7, p0, Landroid/view/WindowOrientationListener$SensorEventListenerImpl;->mHistoryTimestampMS:[J

    aput-wide p2, v7, v4

    .line 579
    iget-object v7, p0, Landroid/view/WindowOrientationListener$SensorEventListenerImpl;->mHistoryMagnitudes:[F

    aput p4, v7, v4

    .line 580
    iget-object v7, p0, Landroid/view/WindowOrientationListener$SensorEventListenerImpl;->mHistoryTiltAngles:[I

    aput p5, v7, v4

    .line 581
    iget-object v7, p0, Landroid/view/WindowOrientationListener$SensorEventListenerImpl;->mHistoryOrientationAngles:[I
    ...
    .line 583
    iget v7, p0, Landroid/view/WindowOrientationListener$SensorEventListenerImpl;->mHistoryLength:I
    ...
    rem-int/lit8 v6, v7, 0x14

    .line 590
    .local v6, olderIndex:I
    if-ltz v6, :cond_2
    ...
    .line 612
    .end local v6           #olderIndex:I
    :cond_5
    iput-wide v1, p0, Landroid/view/WindowOrientationListener$SensorEventListenerImpl;->mProposalAgeMS:J
    ...
    iget-wide v7, p0, Landroid/view/WindowOrientationListener$SensorEventListenerImpl;->mProposalTime:J
    ...
    iput-boolean v7, p0, Landroid/view/WindowOrientationListener$SensorEventListenerImpl;->mProposalSettled:Z
    ...
    invoke-static {v7, v0}, Landroid/view/WindowOrientationListener$SensorEventListenerImpl;->angleAbsoluteDelta(II)I
